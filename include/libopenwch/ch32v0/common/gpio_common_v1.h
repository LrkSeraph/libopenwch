...
/*
 * MMIO32, BITn, BEGIN_DECLS/END_DECLS and the stdint types come from here.
 * The device header normally arrives first, but the common headers are also
...
@{*/
#define GPIO_REMAP_SPI1			(1 << 0)
#define GPIO_REMAP_I2C1_PARTIAL		(1 << 1)
#define GPIO_REMAP_I2C1_FULL		(1 << 2)
#define GPIO_REMAP_USART1_PARTIAL1	(1 << 3)
#define GPIO_REMAP_USART1_PARTIAL2	(1 << 4)
#define GPIO_REMAP_USART1_FULL		(1 << 5)
#define GPIO_REMAP_TIM1_PARTIAL1	(1 << 6)
#define GPIO_REMAP_TIM1_PARTIAL2	(1 << 7)
#define GPIO_REMAP_TIM1_FULL		(1 << 8)
#define GPIO_REMAP_TIM2_PARTIAL1	(1 << 9)
#define GPIO_REMAP_TIM2_PARTIAL2	(1 << 10)
#define GPIO_REMAP_TIM2_FULL		(1 << 11)
#define GPIO_REMAP_PA1_PA2		(1 << 12)
#define GPIO_REMAP_ADC1_ETRGINJ		(1 << 13)
#define GPIO_REMAP_ADC1_ETRGREG		(1 << 14)
#define GPIO_REMAP_LSI_CAL		(1 << 15)
/**@}*/
