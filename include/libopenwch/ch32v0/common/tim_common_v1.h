...
#define TIM_INTFR_IRQ_MASK		(TIM_INTFR_UIF | TIM_INTFR_CC1IF \
					| TIM_INTFR_CC2IF | TIM_INTFR_CC3IF \
					| TIM_INTFR_CC4IF | TIM_INTFR_COMIF \
					| TIM_INTFR_TIF | TIM_INTFR_BIF)

/** All overcapture flag bits. */
#define TIM_INTFR_OVERCAPTURE_MASK	(TIM_INTFR_CC1OF | TIM_INTFR_CC2OF \
					| TIM_INTFR_CC3OF | TIM_INTFR_CC4OF)
